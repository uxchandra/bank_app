...
import 'package:bank_app/ui/widgets/home_latest_transaction_item.dart';
import 'package:bank_app/ui/widgets/home_service_item.dart';
import 'package:bank_app/ui/widgets/home_tips_item.dart';
import 'package:bank_app/ui/widgets/home_user_item.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget builServices(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(
        top: 30,
      ),
        ...
        children: [
          ...
          const SingleChildScrollView(
            ...
            child: Row(
              children: [
                HomeUserItem(
                    imageUrl: 'assets/img_friend1.png', username: 'dewi'),
                HomeUserItem(
                    imageUrl: 'assets/img_friend2.png', username: 'siti'),
                HomeUserItem(
                    imageUrl: 'assets/img_friend3.png', username: 'paijo'),
                HomeUserItem(
                    imageUrl: 'assets/img_friend4.png', username: 'adit'),
              ],
            ),
          )
        ],
